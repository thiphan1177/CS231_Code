...
;;; ;
;;; ; Modification: It removes the last character of the previous
;;; ; printed string as it goes through the loop:
;;; ;
;;; ; to assemble and run:
;;; ;
...
loopthis:
		...
		dec	edx			; decrement edx reg so that it removes the last char in string!!!
		loop	loopthis
