...
;;; ;
;;; ; Modification: It grows the string from 1 char to it's limit.
;;; ;
;;; ; to assemble and run:
;;; ;
...
_start:
	...
	;;;  get a string from the user
		...
		mov 	edx, 1 			; move 1 as the number of chars into edx!
loopthis:
		...
		inc	edx			; increment edx so that it grows the string!!!
		loop	loopthis
